...
# Gerarchia IEC/CT56
È lo standard per gestire la dependability di un sistema. È costituito da varie norme (regole), le quali si citano costruendo una gerarchia con l'idea che quelle inferiori servano ad applicare in modo pratico quelle superiori.
- Principali
...
##### Attributi
Sono detti [parametri RAMS](attributi.md) e sono le proprietà che devono essere verificate per far si che il nostro sia affidabile.
##### Threats
...
##### Means
Per arrivare a un sistema che verifichi gli attributi, e quindi a un sistema affidabile, dobbiamo usare contemporaneamente più tecniche.
- Prevention
...
- Specifiche
	Descrivono cosa il sistema fa (e cosa non fa) in termini di servizio atteso e condizioni in cui questo servizio deve verificarsi. Se usciamo dal range di [conformità](conformità.md) coperto dalle specifiche allora non è detto che il sistema funzioni come le specifiche indicano.
- Fallimento
	È la transizione da un servizio corretto a un servizio non corretto, dove la correttezza è definita come il seguire le specifiche.
...
# Requisiti
I [requisiti](requirement%20engineering.md) nell'ambito della dependability richiedono di analizzare il componente che stiamo definendo all'interno del sistema di cui fa parte, chiedendoci quali siano le conseguenze del suo fallimento all'interno del sistema di cui fa parte.